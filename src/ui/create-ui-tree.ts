import { calculateGridColumnsDimentions, calculateGridRowsDimentions } from './grid/calculate-grid-dimensions';
import { calculateIdAreas, setChildToAppropiateGridCells } from './grid/create-ui-grid-subtree';
import { UiGridBuildTreeNode } from './grid/ui-grid-build-tree-node';
import { DisplayChildrenType } from './style-options';
import { UiButtonTreeNode } from './ui-button-tree-node';
...
export function patchTreeCatchingInteractionFlagUpwards(root: UiBuildTreeNode): void {
...
export function createModal(
  node: UiButtonBuildTreeNode | UiTextBuildTreeNode | UiBlockBuildTreeNode | UiGridBuildTreeNode
): UiTreeNode {
